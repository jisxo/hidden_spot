                ...
                >
                    <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-col gap-2 mt-3 w-full">
                                ...
                                <div className="flex items-start gap-2 text-[11px] font-bold text-slate-400 w-full">
                                    ...
                                    <div className="flex-1 leading-normal">{res.address.split(" ").slice(0, 3).join(" ")}</div>
                                </div>
                                {/* Row 2: Transport */}
                                <div className="flex items-start gap-2 text-[12px] font-bold text-emerald-600 w-full min-w-0">
                                    ...
                                    <div className="flex-1 leading-normal">{res.transport_info?.split(",")[0] || "정보 없음"}</div>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col items-end gap-3 shrink-0">
                            <div className={`w-10 h-10 rounded-xl text-[12px] font-black flex items-center justify-center shrink-0 shadow-sm ${res.ai_score >= 90 ? "bg-emerald-500 text-white shadow-emerald-500/10" :
                                res.ai_score >= 80 ? "bg-orange-500 text-white shadow-orange-500/10" :
