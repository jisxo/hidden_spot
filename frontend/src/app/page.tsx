          ...
          <Dialog open={isRegisterOpen} onOpenChange={setIsRegisterOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] rounded-3xl p-0 bg-transparent border-none shadow-none">
              <div className="bg-white rounded-3xl p-8 text-center space-y-4">
                <DialogHeader>
                  <DialogTitle className="text-xl font-black text-slate-900 text-center uppercase tracking-tight">데모 버전 안내</DialogTitle>
                  <DialogDescription className="text-xs text-slate-500 font-bold text-center">
                    이 페이지는 호스팅 데모용 정적 버전입니다.<br />새로운 맛집 등록 기능은 로컬 환경에서 사용해 주세요.
                  </DialogDescription>
                </DialogHeader>
                <Button onClick={() => setIsRegisterOpen(false)} className="w-full bg-slate-900 rounded-2xl h-12 font-bold text-white mt-2">확인</Button>
              </div>
            </DialogContent>
          </Dialog>
        </div>
